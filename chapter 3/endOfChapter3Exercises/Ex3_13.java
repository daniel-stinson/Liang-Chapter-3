/*
 * Completes the rest of Listing 3, ComputeTax.java, for all filing statuses
 * 
 */
		...
		Scanner input = new Scanner(System.in);
				...
				if (status == 0) { // Compute tax for single filers
					...
					if (income <= 16700)
						...
						tax = 8350 * 0.10 + (67900 - 16700) * 0.15 +
					...
					if (income <= 8350)
						...
						tax = 8350 * 0.10 + (33950 - 8350) * 0.15 +
						(68525 - 33950) * 0.25 + (income - 68526) * 0.28;
					...
					if (income <= 11950)
						...
						tax = 11950 * 0.10 + (45500 - 11950) * 0.15 +
						(117450 - 45500) * 0.25 + (income - 68526) * 0.28;
					else if (income <= 372950)
						tax = 11950 * 0.10 + (45500 - 11950) * 0.15 +
